        ...
        <div class="container">
            ...
            <div class="contact-grid fade-in">
                <div class="contact-info">
                    <h3 style="font-size: 1.25rem; font-weight: 600">Get in Touch</h3>
                    <a href="mailto:ronaldjjuuko7@gmail.com" class="contact-card">
                        ...
                        <div>
                            ...
                            <p class="contact-value">ronaldjjuuko7@gmail.com</p>
                        </div>
                    </a>
                    <a href="tel:+256703283529" class="contact-card">
                        <span class="contact-icon">
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <div>
                            ...
                            <p class="contact-value">+256 703 283 529</p>
                        </div>
                    </a>
                    ...
                    <div class="contact-card" style="flex-direction: column; align-items: flex-start">
                        <p class="contact-label">Connect with me</p>
                        <div class="contact-socials">
                            <a href="https://linkedin.com/in/kclich" target="_blank" rel="noreferrer" aria-label="LinkedIn">
                                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
                                    <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 0 1-2.063-2.065 2.064 2.064 0 1 1 2.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" />
                                </svg>
                            </a>
                            <a href="https://github.com/jjronnie" target="_blank" rel="noreferrer" aria-label="GitHub">
                                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
                            ...
                            <a href="https://x.com/kclich" target="_blank" rel="noreferrer" aria-label="X">
                                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
                ...
                <form id="contact-form" class="contact-form">
                    <h3 style="display:flex;align-items:center;gap:0.5rem;font-size:1.25rem;font-weight:600;margin-top:0.75rem">
                    ...
                    <div style="position: relative; min-height: 340px">
                        <div id="contact-form-content">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="message" required rows="5" placeholder="Tell me about your project..." class="form-textarea"></textarea>
                            </div>
