...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    >
        <div class="relative overflow-x-clip bg-[#050505]">
            ...
            >
                <div class="section-shell flex min-h-screen flex-col py-6 sm:py-8">
                    ...
                    <nav class="my-auto grid gap-4 py-12">
                        <a href="#top" @click="menuOpen = false" class="menu-link">Home</a>
                        <a href="#services" @click="menuOpen = false" class="menu-link">Services</a>
                        <a href="#work" @click="menuOpen = false" class="menu-link">Work</a>
                        <a href="#process" @click="menuOpen = false" class="menu-link">Process</a>
                        <a href="#contact" @click="menuOpen = false" class="menu-link">Contact</a>
                    </nav>
                ...
                <div class="section-shell relative z-10 flex min-h-screen flex-col py-6 sm:py-8">
                    <header class="flex items-center justify-between gap-4 animate-reveal">
                        ...
                        <div class="flex items-center gap-3">
                            <a href="#contact" class="hero-pill">
                                Connect With Me
                            </a>
                    ...
                    <div class="rounded-[2rem] border border-black/15 bg-black/5 p-6 backdrop-blur-sm sm:p-8 lg:p-12">
                        <div class="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-end">
                            ...
                            <div class="flex flex-col gap-3 lg:items-end">
                                <a href="#services" class="action-dark">
                                    View Services
                                </a>
                                <a href="#work" class="action-light">
                                    See Work
                                </a>
                            </div>
                        </div>
            ...
            <footer class="section-shell py-6 text-xs font-semibold uppercase tracking-[0.3em] text-white/35">
                JJUUKO RONALD
            </footer>
        </div>
    </body>
