<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('admin.posts.index')" :active="request()->routeIs('admin.posts.*') || request()->routeIs('admin.post-categories.*')">
                        {{ __('Posts') }}
                    </x-nav-link>

                    <x-nav-link :href="route('admin.post-categories.index')" :active="request()->routeIs('admin.post-categories.*')">
                        {{ __('Post Categories') }}
                    </x-nav-link>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('admin.posts.index')" :active="request()->routeIs('admin.posts.*') || request()->routeIs('admin.post-categories.*')">{{ __('Posts') }}</x-responsive-nav-link>
            <x-responsive-nav-link :href="route('admin.post-categories.index')"
                :active="request()->routeIs('admin.post-categories.*')">{{ __('Post Categories') }}</x-responsive-nav-link>
            ...
            <x-responsive-nav-link :href="route('admin.skills.index')" :active="request()->routeIs('admin.skills.*')">{{ __('Skills') }}</x-responsive-nav-link>
