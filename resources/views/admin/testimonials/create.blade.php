<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Create Testimonial</h2>
    </x-slot>
                    ...
                    <form method="POST" action="{{ route('admin.testimonials.store') }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea name="quote" id="quote" rows="4" required
                                class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('quote') }}</textarea>
                        ...
                        <div>
                            ...
                            <input type="number" name="rating" id="rating" value="{{ old('rating', 5) }}" required min="1" max="5"
                                class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                        ...
                        <div>
                            ...
                            <input type="text" name="avatar_initial" id="avatar_initial" value="{{ old('avatar_initial') }}" maxlength="2"
