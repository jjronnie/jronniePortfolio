<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Create Service</h2>
    </x-slot>
                    ...
                    <form method="POST" action="{{ route('admin.services.store') }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea name="icon_svg" id="icon_svg" rows="5" required
                                class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 font-mono text-xs">{{ old('icon_svg') }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea name="features" id="features" rows="4"
                                class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('features') }}</textarea>
                        ...
                        <div>
                            ...
                            <select name="type" id="type" required
                                ...
                                <option value="beyond" @selected(old('type') === 'beyond')>Beyond</option>
                            </select>
