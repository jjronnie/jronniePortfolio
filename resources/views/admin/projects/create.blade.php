                    ...
                    <form method="POST" action="{{ route('admin.projects.store') }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea name="tags" id="tags" rows="4"
                                class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('tags') }}</textarea>
                        ...
                        <div>
                            ...
                            <input type="url" name="project_url" id="project_url" value="{{ old('project_url') }}" required
                                class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
